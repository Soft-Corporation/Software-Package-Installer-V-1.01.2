...
Public Class Opera_Gx
    ...
    Private Sub Opera_Gx_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_4d29b2955d254942bf2bec34da794c2c.zip"), Texbbb.TextBox32.Text)
        Timer1.Start()
