...
Public Class Shotcut
    ...
    Private Sub Shotcut_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_961bd7f39b284220ae33d77011ebba24.zip"), Texbbb.TextBox27.Text)
