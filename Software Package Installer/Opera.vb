...
Public Class Opera
    ...
    Private Sub Opera_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_6b070c8df2174587b92a119a8bd07d47.zip"), Texbbb.TextBox31.Text)
