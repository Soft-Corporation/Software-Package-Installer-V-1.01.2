...
Public Class Vivaldi
    ...
    Private Sub Vivaldi_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_593646e45de84f0fb8a583a85bd352ee.zip"), Texbbb.TextBox33.Text)
