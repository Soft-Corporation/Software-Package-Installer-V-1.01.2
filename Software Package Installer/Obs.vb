...
Public Class Obs
    ...
    Private Sub Obs_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_d4fbab2369b446b7aad730af2ba31436.zip"), Texbbb.TextBox19.Text)
        Timer1.Start()
